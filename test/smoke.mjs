...
const checks = [
  ...
  ...(() => {
    ...
    // the exports-subpath enumerator: `./styles` -> suffix `/styles`, CSS/wildcard skipped
    ...
    return [
      ...
      ['#147: enumerator returns main + one concrete subpath', subs.length === 2 && subs.includes('') && subs.includes('/styles')],
    ]
  })(),
]
