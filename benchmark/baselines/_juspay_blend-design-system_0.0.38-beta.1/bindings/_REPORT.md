...
| `ContextSharedTypes` | `Center` | `"center"` / `2` | `CenterMarginLane`, `CenterMenuAlignment`, `CenterV2Alignment`, `CenterInitialEtc1mkx8`, `CenterInitialEtc1w3ez`, `CenterInitialEtc2zoye`, `CenterInitialEtcoic7x` |
| `ContextSharedTypes` | `ContextMenu` | `"context-menu"` / `58` | `ContextMenuKeyCode`, `ContextMenuInitialEtcop7hp` |
| `ContextSharedTypes` | `CRLF` | `2` / `1` | `CRLFOfLine`, `CRLFLinePreference`, `CRLFLineSequence` |
| `ContextSharedTypes` | `End` | `"end"` / `13` | `EndKeyCode`, `EndMenuAlignment`, `EndV2Alignment`, `EndInitialEtc1w3ez`, `EndInitialEtcoic7x` |
| `ContextSharedTypes` | `Explicit` | `3` / `"explicit"` | `ExplicitCaretAnimation`, `ExplicitChangeReason` |
| `ContextSharedTypes` | `Highlight` | `"Highlight"` / `"highlight"` | `HighlightSelectionStyle`, `HighlightInitialEtc1270i`, `HighlightInitialEtc1i3k7`, `HighlightInitialEtc1mkx8`, `HighlightInitialEtc1yz1q`, `HighlightInitialEtcgjquu`, `HighlightInitialEtcsclw8` |
...
| `ContextSharedTypes` | `Left` | `"left"` / `0` / `1` | `LeftOutsidePosition`, `LeftMarginLane`, `LeftMenuSide`, `LeftV2Side`, `LeftInitialEtc1mkx8`, `LeftInitialEtc1w3ez`, `LeftInitialEtc2zoye`, `LeftV2Direction`, `LeftPositionAffinity`, `LeftDropdownPosition` |
| `ContextSharedTypes` | `LF` | `1` / `0` | `LFOfLine`, `LFLinePreference`, `LFLineSequence` |
| `ContextSharedTypes` | `None` | `"none"` / `0` / `2` | `NoneOptionsAutohide`, `NoneAutoIndent`, `NoneLineHighlight`, `NoneRenderWhitespace`, `NoneSnippetSuggestions`, `NoneWrappingIndent`, `NoneInitialEtc1i3k7`, `NoneInitialEtc1mkx8`, `NoneInitialEtc1ufa7`, `NoneInitialEtc1x0av`, `NoneInitialEtc1yz1q`, `NoneInitialEtc2zoye`, `NoneInitialEtcc55tl`, `NoneInitialEtcop7hp`, `NoneInitialEtcsclw8`, `NoneInitialEtcydel2`, `NoneInitialEtcz3a4s`, `NonePositionAffinity`, `NoneRenderMinimap` |
| `ContextSharedTypes` | `Right` | `"right"` / `1` / `3` | `RightOutsidePosition`, `RightMarginLane`, `RightMenuSide`, `RightV2Side`, `RightInitialEtc1mkx8`, `RightInitialEtc1w3ez`, `RightInitialEtc2zoye`, `RightV2Direction`, `RightPositionAffinity`, `RightDropdownPosition` |
| `ContextSharedTypes` | `Scrollbar` | `"Scrollbar"` / `117` | `ScrollbarEditorOption`, `ScrollbarInitialEtc1270i`, `ScrollbarInitialEtc1i3k7`, `ScrollbarInitialEtc1mkx8`, `ScrollbarInitialEtc1yz1q`, `ScrollbarInitialEtcgjquu`, `ScrollbarInitialEtcsclw8` |
...
| `ContextSharedTypes` | `Space` | `"space"` / `10` | `SpaceKeyCode`, `SpaceInitialEtc1mkx8` |
| `ContextSharedTypes` | `Text` | `"text"` / `1` | `TextMouseStyle`, `TextInitialEtcop7hp`, `TextTagType`, `TextRenderMinimap` |
