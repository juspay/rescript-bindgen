...
external renderFn: ((PositionerSharedTypes.htmlProps, PositionerSharedTypes.selectPositionerState) => React.element) => React.element = "%identity"
...
external make: (
  ...
  ~style: PositionerSharedTypes.selectPositionerStyle=?,
  ~title: string=?,
  ~autoFocus: bool=?,
  ~hidden: bool=?,
  ~id: string=?,
  ...
  ~className: PositionerSharedTypes.selectPositionerClassName=?,
