...
external renderFn: ((PositionerSharedTypes.htmlProps, PositionerSharedTypes.comboboxPositionerState) => React.element) => React.element = "%identity"
...
external make: (
  ...
  ~style: PositionerSharedTypes.comboboxPositionerStyle=?,
  ~title: string=?,
  ~autoFocus: bool=?,
  ~hidden: bool=?,
  ~id: string=?,
  ...
  ~className: PositionerSharedTypes.comboboxPositionerClassName=?,
