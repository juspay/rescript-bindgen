...
type floatingRootStore = {
  setOpen: (bool, PositionerTabUtilsTypes.setOpenConfig2) => unit,
...
type useSyncedValuesConfig<'a> = {
  ...
  activeTriggerProps?: PositionerTabUtilsTypes.htmlProps,
  inactiveTriggerProps?: PositionerTabUtilsTypes.htmlProps,
  popupProps?: PositionerTabUtilsTypes.htmlProps,
  modal?: CommonTypes.boolOrTrapFocus,
  disablePointerDismissal?: bool,
  openMethod?: PositionerTabUtilsTypes.interactionType,
  nested?: bool,
...
type useSyncedValuesConfig3 = {
  ...
  itemProps?: PositionerTabUtilsTypes.htmlProps,
  closeDelay?: float,
...
type context3 = {
  ...
  triggerFocusTargetRef: React.ref<Nullable.t<Dom.element>>,
  beforeContentFocusGuardRef: React.ref<Nullable.t<Dom.element>>,
  stickIfOpenTimeout: PositionerTabUtilsTypes.timeout,
}
