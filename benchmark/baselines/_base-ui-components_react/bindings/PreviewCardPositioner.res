...
external make: (
  ...
  ~style: PositionerTabUtilsTypes.previewCardPositionerStyle=?,
  ~title: string=?,
  ~autoFocus: bool=?,
  ~hidden: bool=?,
  ~id: string=?,
  ...
  ~className: PositionerTabUtilsTypes.previewCardPositionerClassName=?,
  ~render: React.element=?,
) => React.element = "PreviewCardPositioner"
