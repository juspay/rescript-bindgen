...
@unboxed type comboboxPositionerStyle = Style(JsxDOM.style) | Fn(comboboxPositionerState => option<JsxDOM.style>)
@unboxed type comboboxPositionerClassName = Str(string) | Fn(comboboxPositionerState => option<string>)
@unboxed type menuPositionerStyle = Style(JsxDOM.style) | Fn(menuPositionerState => option<JsxDOM.style>)
@unboxed type menuPositionerClassName = Str(string) | Fn(menuPositionerState => option<string>)
@unboxed type navigationMenuPositionerStyle = Style(JsxDOM.style) | Fn(navigationMenuPositionerState => option<JsxDOM.style>)
@unboxed type navigationMenuPositionerClassName = Str(string) | Fn(navigationMenuPositionerState => option<string>)
@unboxed type popoverPositionerStyle = Style(JsxDOM.style) | Fn(popoverPositionerState => option<JsxDOM.style>)
@unboxed type popoverPositionerClassName = Str(string) | Fn(popoverPositionerState => option<string>)
@unboxed type previewCardPositionerStyle = Style(JsxDOM.style) | Fn(previewCardPositionerState => option<JsxDOM.style>)
@unboxed type previewCardPositionerClassName = Str(string) | Fn(previewCardPositionerState => option<string>)
@unboxed type selectPositionerStyle = Style(JsxDOM.style) | Fn(selectPositionerState => option<JsxDOM.style>)
@unboxed type selectPositionerClassName = Str(string) | Fn(selectPositionerState => option<string>)
@unboxed type tabsTabStyle = Style(JsxDOM.style) | Fn(tabsTabState => option<JsxDOM.style>)
@unboxed type tabsTabClassName = Str(string) | Fn(tabsTabState => option<string>)
@unboxed type toastPositionerClassName = Str(string) | Fn(toastPositionerState => option<string>)
@unboxed type toastPositionerStyle = Style(JsxDOM.style) | Fn(toastPositionerState => option<JsxDOM.style>)
