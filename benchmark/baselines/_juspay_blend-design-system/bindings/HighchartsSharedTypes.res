...
module SeriesOptionsType = {
  ...
  external fromSeriesLinearregressioninterceptOptions: seriesLinearregressioninterceptOptions => t = "%identity"
  external fromSeriesLinearregressionOptions: seriesLinearregressionOptions => t = "%identity"
  external fromSeriesLinearregressionslopeOptions: seriesLinearregressioninterceptOptions => t = "%identity"
