...
type clearButtonConfig = {
  backgroundColor: MultiSelectSingleSelectTypes.containerConfig4,
  outline: MultiSelectSingleSelectTypes.containerConfig4,
  color: string,
  width?: string,
}
...
type itemConfig11 = {
  ...
  seperator: MultiSelectSingleSelectTypes.seperatorConfig2,
}
type menuConfig5 = {
  backgroundColor: string,
  border: string,
...
type componentTokenType = {
  ...
  @as("BUTTON") bUTTON?: ButtonSkeletonTypes.responsiveButtonTokens,
  ...
  @as("MULTI_SELECT") mULTI_SELECT?: MultiSelectSingleSelectTypes.responsiveMultiSelectTokens,
  @as("SINGLE_SELECT") sINGLE_SELECT?: MultiSelectSingleSelectTypes.responsiveSingleSelectTokens,
  ...
  @as("SKELETON") sKELETON?: ButtonSkeletonTypes.responsiveSkeletonTokens,
  ...
  @as("CHARTSV2") cHARTSV2?: ChartsV2HighchartsOptionsTypes.responsiveChartV2Tokens,
