...
### Left as-is — same name, same runtime value (115)
...
- `EditorSharedTypes`: `Advanced`, `All`, `Always`, `Auto`, `Brackets`, `Default`, `Full`, `LanguageDefined`, `Line`, `Mouseover`, `Never`, `Off`, `On`, `Selection`
