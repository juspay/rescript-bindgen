...
**3298** shared types deduplicated into **74** `*Types.res` modules (referenced qualified — no per-file redeclaration).
...
### Left as-is — same name, same runtime representation (143)
