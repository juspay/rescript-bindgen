...
type rec range = {
  ...
  equalsRange: Nullable.t<option<iRange>> => bool,
...
type iCodeEditor<'a> = {
  ...
  executeCommand: (Nullable.t<option<string>>, iCommand<'a>) => unit,
  pushUndoStop: unit => bool,
  popUndoStop: unit => bool,
  executeEdits: (Nullable.t<option<string>>, array<iIdentifiedSingleEditOperation>, option<codeEditorV2ICodeEditorExecuteEdits>) => bool,
  executeCommands: (Nullable.t<option<string>>, array<iCommand<'a>>) => unit,
  ...
  trigger: (Nullable.t<option<string>>, string, string) => unit,  // 🛑 BROKEN — contains `any`
...
type iStandaloneCodeEditor<'a, 'b> = {
  ...
  pushUndoStop: unit => bool,
  popUndoStop: unit => bool,
  executeEdits: (Nullable.t<option<string>>, array<iIdentifiedSingleEditOperation>, option<codeEditorV2IStandaloneCodeEditorExecuteEdits>) => bool,
  executeCommands: (Nullable.t<option<string>>, array<iCommand<'a>>) => unit,
  getLineDecorations: float => Nullable.t<array<iModelDecoration>>,
  getDecorationsInRange: range => Nullable.t<array<iModelDecoration>>,
  getFontSizeAtPosition: iPosition => Nullable.t<string>,
